...
resource "aws_db_instance" "rds_master" {
  ...
  backup_retention_period = var.rds_retention_period # Creates new backup every few days, defined here.
  backup_window           = var.rds_backup_window    # Define the time for performing of backup.
  multi_az                = false
